...
<head>
    ...
    <style>
        ...
        :root {
            --primary-color: {
                    {
                    $siteSettingsGlobal->primary_color ?? '#4CAF50'
                }
            }

            ;

            /* Exemple: rendre les couleurs dynamiques */
            --secondary-color: {
                    {
                    $siteSettingsGlobal->secondary_color ?? '#2E7D32'
                }
            }
            ...
            --primary-color-rgb: {
                    {
                    implode(',', sscanf($siteSettingsGlobal->primary_color ?? '#4CAF50', "#%02x%02x%02x"))
                }
            }
            ...
            --secondary-color-rgb: {
                    {
                    implode(',', sscanf($siteSettingsGlobal->secondary_color ?? '#2E7D32', "#%02x%02x%02x"))
                }
            }
            ...
            --accent-color-rgb: {
                    {
                    implode(',', sscanf($siteSettingsGlobal->accent_color ?? '#8BC34A', "#%02x%02x%02x"))
                }
            }
        ...
        body {
            ...
            /* Fond général du corps */
        }

        main {
            flex-grow: 1;
            padding-top: 2rem;
            /* Espace après la navbar sticky */
            padding-bottom: 2rem;
        ...
        .navbar-brand img {
            ...
            max-height: 45px;
            /* Taille max pour le logo */
        }

        .navbar.scrolled .navbar-brand img {
            max-height: 40px;
            /* Logo légèrement plus petit au scroll */
        }
        ...
        .nav-link:after {
            ...
            height: 2px;
            bottom: -2px;
            /* Légèrement en dessous du texte */
            left: 50%;
        ...
        .footer-links a {
            ...
            /* Pour que le padding s'applique bien */
        }
        ...
        footer address p i.fas {
            /* Cibler spécifiquement les icônes FA */
            color: var(--primary-color);
            width: 25px;
            /* Espace pour l'icône */
            text-align: center;
